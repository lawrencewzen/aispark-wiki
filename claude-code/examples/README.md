...
| [`skills/`](./skills/) | Reusable knowledge modules — [9 on SkillHub](https://) | 68 |
...
| [`multi-provider/`](https://github.com/claude-code-ultimate-guide/cc-copilot-bridge) | Multi-provider bridge → dedicated repo | — |
...
| Tool | Purpose |
|------|---------|
| [cc-copilot-bridge](https://github.com/claude-code-ultimate-guide/cc-copilot-bridge) | Bridge GitHub Copilot to Claude Code CLI for flat-rate access |

> Moved to dedicated repository: [github.com/claude-code-ultimate-guide/cc-copilot-bridge](https://github.com/claude-code-ultimate-guide/cc-copilot-bridge)
