...
> - Landing scanner: Check <local-path> and examples.html for version in footer+FAQ, template count in badges, eval count, guide lines approximation (~9800+)
>
...
> - Landing scanner: Check <local-path> and examples.html for version, counts, guide lines approximation
```
