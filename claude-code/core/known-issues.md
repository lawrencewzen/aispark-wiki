...
Run `/check-cache-bugs` (install from the [examples/commands](https://github.com/claude-code-ultimate-guide/claude-code-ultimate-guide/blob/main/examples/commands/check-cache-bugs.md) directory) to audit your setup for all three bugs in ~20 seconds.
...
To suggest updates: Open issue in [claude-code-ultimate-guide](https://github.com/claude-code-ultimate-guide/claude-code-ultimate-guide/issues) with:
