...
*This glossary covers ~130 terms. For the full guide, see [ultimate-guide.md](../ultimate-guide.md). To suggest a missing term, open an issue on [GitHub](https://github.com/claude-code-ultimate-guide/claude-code-ultimate-guide/issues).*
